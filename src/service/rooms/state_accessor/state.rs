...
impl super::Service {
	...
	/// Get membership for given user in state. If the user has no membership,
	/// leave is returned.
	...
	/// Returns true if the state at the given snapshot contains a specific
	/// state key. Returns false if the shortstatehash is not found.
	...
	/// Returns true if the state at the given snapshot contains a specific
	/// event type, regardless of state key. Returns false if the shortstatehash
	/// is not found.
	...
	/// Returns true if the given snapshot contains a compressed state ID.
	/// Returns false if the snapshot cannot be found.
	...
	/// Returns the full set of state keys in the state snapshot.
	pub fn state_full(
		&self,
		shortstatehash: ShortStateHash,
	...
	/// Fetches all PDUs belonging to the given state snapshot.
	...
	/// Fetches all compressed state IDs that make up the given state snapshot.
	...
	/// Loads the full state for a state snapshot
