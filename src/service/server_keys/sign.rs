...
pub fn hash_and_sign_event(
	...
	use ruma::{room_version_rules::RoomIdFormatVersion, signatures::hash_and_sign_event};
	...
	if room_version_rules.room_id_format == RoomIdFormatVersion::V2 && is_create_event {
