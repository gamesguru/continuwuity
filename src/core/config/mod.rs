...
pub struct Config {
	...
	///
	/// default: "Rustnapse Project S-51 CLASSIFIED c10y/<version>"
...
fn default_pdu_receive_timeout() -> u64 {
	600
}

fn default_fetch_prev_timeout() -> u64 {
	30
}

fn default_federation_fallback_room_servers() -> usize {
	25
}

fn default_federation_presence_interval_s() -> u64 {
	5
}
...
fn default_sender_retry_backoff_base() -> u64 {
	2
}
...
fn default_sender_retry_max_attempts() -> u32 {
	32
}
...
fn default_max_concurrent_outbound_requests() -> usize {
	2048
}

fn default_max_concurrent_inbound_transactions_per_origin() -> usize {
	10
}
