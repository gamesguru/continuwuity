...
pub async fn join_room_by_id_helper(
	...
	json_body: Option<&CanonicalJsonObject>,
) -> Result<join_room_by_id::v3::Response> {
...
async fn join_room_by_id_helper_remote(
	...
	let mut content =
		to_canonical_value(assign!(RoomMemberEventContent::new(MembershipState::Join), {
